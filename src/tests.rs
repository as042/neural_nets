...
// To run one of these tests:
// cargo test <test_name> --release -- --ignored --show-output

#[test]
#[ignore = "Slow test, needs to be run in release mode"]
...
fn polynomial_arithmetic_data_set() -> DataSet<f64> {
    let mut data_set = DataSet::builder();
